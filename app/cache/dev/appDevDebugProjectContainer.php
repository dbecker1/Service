...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'b6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca18_1' => 'getB6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca181Service',
            ...
            'maclay_service.accountservice' => 'getMaclayService_AccountserviceService',
    ...
    /**
     * Gets the '1a69a8140161fad4f909ff5575ea1eb713a5fd088545527d064d1a771af4ed14_1' service.
     *
    ...
    /**
     * Gets the '1a69a8140161fad4f909ff5575ea1eb713a5fd088545527d064d1a771af4ed14_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the '1a69a8140161fad4f909ff5575ea1eb713a5fd088545527d064d1a771af4ed14_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/assetic/config'), true)));
    ...
    /**
     * Gets the 'b6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca18_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca181Service()
    {
        return $this->services['b6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca18_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'maclayservice', 'user' => 'dbecker', 'password' => 'dbecker', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_179667f97eec7b45d77ad1b6a32eedc4e618a8f650e656c7d908a57fd9825621');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_179667f97eec7b45d77ad1b6a32eedc4e618a8f650e656c7d908a57fd9825621');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_179667f97eec7b45d77ad1b6a32eedc4e618a8f650e656c7d908a57fd9825621');
        ...
        $e->addDriver($d, 'Maclay\\ServiceBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('MaclayServiceBundle' => 'Maclay\\ServiceBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('b6b71a62ad282185e1967c29f8d98de82be1b2051ed3fdd9ffd1f0c09ce2ca18_1'), $this->get('data_collector.form'));
    }
    ...
    /**
     * Gets the 'maclay_service.accountservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maclay\ServiceBundle\Controller\AccountServiceController A Maclay\ServiceBundle\Controller\AccountServiceController instance.
     */
    protected function getMaclayService_AccountserviceService()
    {
        return $this->services['maclay_service.accountservice'] = new \Maclay\ServiceBundle\Controller\AccountServiceController();
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/XAMPP/xamppfiles/htdocs/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/XAMPP/xamppfiles/htdocs/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/XAMPP/xamppfiles/htdocs/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/XAMPP/xamppfiles/htdocs/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.administrators'), new \Symfony\Component\Security\Core\User\UserChecker(), 'demo_secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('PARENT' => array(0 => 'Parent'), 'STUDENT' => array(0 => 'Student'), 'TEACHER' => array(0 => 'Teacher'), 'COORDINATOR' => array(0 => 'Parent', 1 => 'Student', 2 => 'Teacher', 3 => 'Coordinator'), 'ADMIN' => array(0 => 'Coordinator', 1 => 'Admin')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'MaclayServiceBundle:User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev',
            ...
            'debug.container.dump' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/XAMPP/xamppfiles/htdocs/app/cache/dev/doctrine/orm/Proxies',
            ...
            'maclay_service.accountservice.class' => 'Maclay\\ServiceBundle\\Controller\\AccountServiceController',
